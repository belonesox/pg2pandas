...
setup(
    name='pg2pandas',
    version=__version__,
    description='Fast and optimized loading of large Dataset from postgres DB to Pandas frame',
    long_description='''
Fast and optimized loading of large Dataset from postgres DB to Pandas frame
''',
    keywords='Pandas Postgres',
    author='Stas Fomin',
    author_email='stas-fomin@yandex.ru',
    url='https://github.com/belonesox/pg2pandas',
    license='MIT',
    classifiers=[
